...
- [x] 1.4 Capture a populated roster in the review suite
- [x] 1.5 Run the shell tests, validation set, and the XCUI suite in both appearances (70 shell tests; XCUI 18 tests light and dark)
